...
/*
the array is splitted into two subsets that are equal
thats mean every subset sum = array.sum / 2
so we search for that number in a function subset_sum which we created before
*/
